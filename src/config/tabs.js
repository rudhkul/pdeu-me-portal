...
export const TABS = [
...

  {
    ...
    fields: [
      { key: 'academic_year',         label: 'Academic Year',                                           type: 'select', options: ACADEMIC_YEARS,                                        required: true },
      { key: 'semester_type',         label: 'Semester Type',                                           type: 'select', options: ['Even', 'Odd'],                                       required: true },
      { key: 'semester_number',       label: 'Semester Number',                                         type: 'select', options: ['1','2','3','4','5','6','7','8'],                      required: true },
      { key: 'branch',                label: 'Branch / Programme',                                      type: 'text',                                                                    required: true },
      { key: 'course_name',           label: 'Name of Course',                                          type: 'text',                                                                    required: true },
      { key: 'course_code',           label: 'Course Code',                                             type: 'text',                                                                    required: true },
      { key: 'theory_or_lab',         label: 'Theory / Lab',                                            type: 'select', options: ['Theory', 'Lab', 'Theory & Lab'],                     required: true },
      ...
      { key: 'mid_qp_pdf',            label: 'Upload Mid Semester Question Paper (PDF)',                type: 'proof_upload', required: true },
      { key: 'mid_iqac_review_pdf',   label: 'Upload IQAC Review of Mid Semester QP (PDF)',            type: 'proof_upload', required: true },
      { key: 'mid_action_taken_pdf',  label: 'Upload Action Taken Report — Mid Semester QP (PDF)',     type: 'proof_upload', required: true },

      // ── End Semester Question Paper ─────────────────────────
      { key: 'end_qp_pdf',            label: 'Upload End Semester Question Paper (PDF)',                type: 'proof_upload', required: true },
      { key: 'end_iqac_review_pdf',   label: 'Upload IQAC Review of End Semester QP (PDF)',            type: 'proof_upload', required: true },
      { key: 'end_action_taken_pdf',  label: 'Upload Action Taken Report — End Semester QP (PDF)',     type: 'proof_upload', required: true },
    ],
  },
